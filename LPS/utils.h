...
#ifndef M_LPS_UTILS_H
#define M_LPS_UTILS_H

#include <stdarg.h>
#include "commonheaders.h"

//#define USE_LOG
#define LOG_FILE "lps.log"
...
struct InterfaceTable {
	int defMod;
	MUUID defModInterface;
	char *name;
};

extern InterfaceTable defaultInterfaces[];
extern int cDefaultInterfaces;
